<?php 
    ...
    if (isset($_REQUEST['btn_insert'])) {
        try {
            ...
            $lat = $_REQUEST['txt_lat'];
            $lng = $_REQUEST['txt_lng'];
            ...
            if (empty($name)) {
                ...
                $errorMsg = "Please Enter Longtitude";
            ...
            if (!isset($errorMsg)) {
                $insert_stmt = $db->prepare('INSERT INTO tbl_file(name,image,lat,lng) VALUES (:fname, :fimage,:flat,:flng)');
                $insert_stmt->bindParam(':fname', $name);
                $insert_stmt->bindParam(':flat', $lat);
                $insert_stmt->bindParam(':flng', $lng);
...
<body>
    ...
    <div class="container text-center">
        ...
        <div class="form-group">
            <div class="row">
            <label for="name" class="col-sm-3 control-label">Latitude</label>
            <div class="col-sm-9">
                <input type="text" name="txt_lat" class="form-control" placeholder="Enter Latitude">
            </div>
            </div>
        </div>
        <div class="form-group">
            <div class="row">
            <label for="name" class="col-sm-3 control-label">Longitude</label>
            <div class="col-sm-9">
                <input type="text" name="txt_lng" class="form-control" placeholder="Enter Longitude">
            </div>
            </div>
        </div>
        <div class="form-group">
