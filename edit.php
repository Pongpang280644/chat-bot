<?php 
    ...
    if (isset($_REQUEST['btn_update'])) {
        try {
            ...
            if (!isset($errorMsg)) {
                $update_stmt = $db->prepare("UPDATE tbl_file SET name = :name_up,lat = :lat_up,lng = :lng_up, image = :file_up WHERE id = :id");
                $update_stmt->bindParam(':name_up', $name);
                $update_stmt->bindParam(':lat_up', $lat);
                $update_stmt->bindParam(':lng_up', $lng);
...
<body>
    ...
    <div class="container text-center">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" name="txt_lat" class="form-control" value="<?php echo $lat; ?>">
            </div>
            </div>
        </div>
        <div class="form-group">
            <div class="row">
            <label for="name" class="col-sm-3 control-label">Longtitude</label>
            <div class="col-sm-9">
                <input type="text" name="txt_lng" class="form-control" value="<?php echo $lng; ?>">
            </div>
            </div>
        </div>
        <div class="form-group">
